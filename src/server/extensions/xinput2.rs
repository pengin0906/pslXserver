...
async fn handle_list_input_devices<S: AsyncRead + AsyncWrite + Unpin>(
    ...
    let devices = [
        ...
        DevInfo { type_atom: pointer_atom, id: SLAVE_POINTER as u8, use_type: 4, name: "Xserver pointer", has_key_class: false },
        DevInfo { type_atom: keyboard_atom, id: SLAVE_KEYBOARD as u8, use_type: 3, name: "Xserver keyboard", has_key_class: true },
    ];
