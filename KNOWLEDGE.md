...
## 修正履歴 (2026-03-07)
- **ListFonts高速化**: `/opt/X11`から4604フォントを読み込んでいたのをやめ、6個のハードコードリストに変更。ListFontsレスポンスが1000分の1になりxterm起動が大幅高速化。Xserverはどのフォントもファイルから読まず全てCoreTextで描画するので、ファイルシステムフォントを広告する意味がない
